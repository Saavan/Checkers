...
public class Location implements Comparable
{
    ...
    /**
     * Returns distance to another location using Geometric Distance Formula
     * 
     * @param L
     * @return A double distance which corresponds to the distance
     */
    public double distanceTo(Location L)
    {
        return Math.sqrt(Math.pow(row-L.getRow(), 2)+Math.pow(col-L.getCol(), 2));
    }
    ...
    /**
     * Gives a Location based on the string given, must be in form "row, col"
     * @param str
     * @return location string represented
     */
